...
import { Menu, X, Facebook, Instagram, Twitter, Linkedin, Phone } from "lucide-react";
      ...
      <div className="container mx-auto">
          ...
          <div className="hidden md:flex items-center space-x-3">
            ...
            <Link href="/voice">
              <a>
                <Button 
                  size="sm" 
                  className="bg-gradient-to-r from-green-500 to-teal-500 hover:opacity-90 transition-opacity"
                >
            ...
            {/* WhatsApp Chat Button - Coming Soon */}
        ...
        {mobileMenuOpen && (
          <div className="md:hidden py-4 space-y-4 border-t border-border/50">
            ...
            <Link href="/voice">
              <a className="block py-2 text-green-400 hover:text-green-300 transition-colors font-medium flex items-center">
                <Phone className="h-4 w-4 mr-2" />
                Voice Chat with Mama Dennis
              </a>
            </Link>
