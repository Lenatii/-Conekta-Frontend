...
export default function MamaDennisChatWidget() {
  ...
  const [messages, setMessages] = useState<Message[]>([
    {
      ...
      quickActions: [
        ...
        { label: "Get Verified 🛡️", action: "ubaru", icon: "shield" },
  ...
  const handleQuickAction = (action: string) => {
    ...
    switch (action) {
      ...
      case "fundi":
        ...
        break;
      case "ubaru":
        message = "Tell me about UBARU verification";
        break;
      case "short-stay":
  ...
  const getSuggestedActions = (response: string): QuickAction[] | undefined => {
    ...
    if (lower.includes("ubaru") || lower.includes("verify")) {
      return [
        { label: "Get Verified", action: "How do I get UBARU verified?" },
        { label: "Learn More", action: "Tell me more about UBARU" },
      ];
    }
